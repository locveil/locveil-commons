"""Mock wb-mqtt-bridge — the SUT-facing half of the device-command contract tests (TEST-18 B).
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Mock wb-mqtt-bridge for contract tests")
