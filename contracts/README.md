...
| [`contract-guard`](contract-guard/README.md) | cross-ref — artifact stays runnable at `../packages/contract-guard/contract_guard.py` (this very checker; drift-checked) | `contract-guard/STAMP.json` + tag `contract-guard-v3.1` (v1/v2 pre-stamp history) |
