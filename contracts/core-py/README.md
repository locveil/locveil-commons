...
- **Version authority**: `STAMP.json` + tag `core-py-v1`. Semantics/behavior questions:
  the design doc `../../../locveil-voice/docs/design/core_py_loader_extraction.md` and
  the behavior suite `../../packages/core-py/tests/`.
