...
The reusable MQTT piece. Primary consumer is locveil-bridge (which talks MQTT directly);
locveil-voice only touches the retained `bridge/catalog/version` topic.
