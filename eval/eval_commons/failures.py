"""Keep-on-failure trace capture (D-13 / locveil-voice TEST-13) — project-agnostic.
...
No project specifics — locveil-bridge (and any future consumer) reuses this unchanged. It honours the
harness rule: execution/glue logic lives in locveil-commons; projects carry YAML + a thin Makefile that
